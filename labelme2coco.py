...
https://blog.csdn.net/wenyunick/article/details/122190469
...
class Lableme2CoCo:
    ...
    def _image(self, obj, path):
        ...
        img_x = utils.img_b64_to_arr(obj['imageData'])  #imageData: 千万不可为null!
        h, w = img_x.shape[:-1]
        image['height'] = h
        image['width'] = w
...
if __name__ == '__main__':
    labelme_path = "/home/moo/qp/sx/demo"
    saved_coco_path = "/home/moo/qp/sx/coco/"
    # 创建文件
